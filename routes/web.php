...
Route::get('/dashboard', 'DashboardController@index')->middleware('loggedIn')->name('dashboard');

Route::prefix('forum')->group(function(){
    Route::get('/', 'ForumController@index')->name('forum');
    Route::get('/{cat}', 'ForumController@showCat')->middleware('loggedIn')->name('forum_cat');
    Route::get('/{cat}/topic', 'ForumController@newTopic')->middleware('loggedIn', 'banned')->name('forum_create_topic');
    ...
    Route::get('/user/{id}', 'CharController@member')->middleware('loggedIn')->name('member');
